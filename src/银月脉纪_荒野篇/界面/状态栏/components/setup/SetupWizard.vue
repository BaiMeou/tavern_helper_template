...
// ─── 120件物品池 ───
interface ItemOption { id: string; icon: string; 名称: string; 重量: number; 分类: string; 描述: string; 耐久度?: number; 使用次数剩余?: number; 数量?: number; 容量?: number; 保暖值?: number; 锋利度?: number; 电量?: number; }
const ITEM_POOL: ItemOption[] = [
  ...
  { id:'撬棍',icon:'🔧',名称:'撬棍',重量:0.5,分类:'工具',描述:'撬开卡住的舱门、箱子、移动重物——金属杠杆永不失效',耐久度:100},
  { id:'钳子',icon:'🔧',名称:'多功能钳子',重量:0.2,分类:'工具',描述:'夹取、弯折金属线、剪断铁丝——制作陷阱机关的精密工具',耐久度:100},
  { id:'卷尺',icon:'📏',名称:'卷尺5m',重量:0.1,分类:'工具',描述:'精确测量——判断庇护所尺寸、估算水深、丈量陷阱间距'},
  { id:'刮刀',icon:'🔪',名称:'铲刀/刮刀',重量:0.15,分类:'工具',描述:'剥树皮取纤维、清理皮革、刮除铁锈——精细加工的利器',耐久度:100},
  // 容器 (11)
  ...
  { id:'玻璃瓶',icon:'🧴',名称:'玻璃瓶(带密封盖)',重量:0.2,分类:'容器',描述:'密封储存干燥食材或药粉——透明可观察内容物'},
  { id:'兽皮水袋',icon:'🫗',名称:'兽皮水袋(手工)',重量:0.15,分类:'容器',描述:'手工缝制的兽皮水袋——天然材料，耐久但需定期维护',容量:1.5},
  { id:'折叠杯',icon:'🥤',名称:'折叠杯×2',重量:0.1,分类:'容器',描述:'轻便的硅胶折叠杯——热饮冷饮皆宜',数量:2},
  // 食物 (14)
  ...
  { id:'盐罐',icon:'🧂',名称:'盐罐',重量:0.3,分类:'食物',描述:'满满一罐细盐——调味、腌渍肉类延长保存×3-5。荒野硬通货'},
  ...
  { id:'咖啡粉',icon:'☕',名称:'咖啡粉(小罐)',重量:0.1,分类:'食物',描述:'提神醒脑——寒冷清晨的一杯热咖啡。约15杯份'},
  ...
  { id:'巧克力',icon:'🍫',名称:'黑巧克力×3',重量:0.15,分类:'食物',描述:'高能量精神慰藉——可可含量72%。荒野中的奢侈品',数量:3},
  { id:'茶叶',icon:'🍃',名称:'茶叶(小罐)',重量:0.05,分类:'食物',描述:'热茶暖身提神——茉莉花茶。在荒野中闻到这个味道会想起主人'},
  { id:'维生素片',icon:'💊',名称:'维生素片×30',重量:0.03,分类:'食物',描述:'全面的维生素和矿物质补充——每天一粒。长期缺乏蔬果的救星',数量:30},
  { id:'即食汤料',icon:'🍜',名称:'即食汤料×4',重量:0.15,分类:'食物',描述:'热水冲泡即成热汤——在寒冷夜晚的心理慰藉远超其营养价值',数量:4},
  // 庇护 (11)
  { id:'帐篷',icon:'⛺',名称:'双人帐篷',重量:2.5,分类:'庇护',描述:'完整的双人帐篷——外袋略潮湿内部干燥。笨重但在深秋荒野是最可靠的庇护基础',耐久度:100},
  { id:'保温毯',icon:'🥈',名称:'铝箔保温毯',重量:0.1,分类:'庇护',描述:'折叠完好——反射体热和篝火热辐射。可与帐篷组合成保温毯帐篷',耐久度:100},
  ...
  { id:'地钉',icon:'📌',名称:'地钉×6',重量:0.3,分类:'庇护',描述:'铝合金Y型地钉——固定帐篷和防水布。在硬地或沙地中稳固',耐久度:100},
  { id:'绳扣',icon:'🪢',名称:'登山绳扣×4',重量:0.1,分类:'庇护',描述:'快速固定和调节绳索张力——搭建庇护所的效率工具'},
  { id:'充气枕头',icon:'🛏️',名称:'充气枕头',重量:0.08,分类:'庇护',描述:'小小奢侈——但好的睡眠在荒野中不是奢侈是生存必需品',耐久度:100},
  // 武器 (14)
  ...
  { id:'折叠弓',icon:'🏹',名称:'折叠弓+箭×6',重量:0.8,分类:'武器',描述:'可狩猎中型猎物——但需要相当练习。箭矢可回收(约50%找回率)',耐久度:100},
  ...
  { id:'工兵铲',icon:'🪏',名称:'工兵铲',重量:0.9,分类:'武器',描述:'多功能——挖掘、劈砍、锯切。可折叠收纳',耐久度:100},
  { id:'甩棍',icon:'🪯',名称:'甩棍',重量:0.4,分类:'武器',描述:'轻便防身武器——甩出即锁定。威慑大于实际杀伤力',耐久度:100},
  { id:'弹丸包',icon:'🔴',名称:'弹丸补充包×50',重量:0.15,分类:'武器',描述:'弹弓专用钢珠弹丸——安静、可回收(约60%)。小型猎物狩猎用',数量:50},
  { id:'备用弓弦',icon:'🧵',名称:'备用弓弦×2',重量:0.03,分类:'武器',描述:'折叠弓的备用弦——弓弦在潮湿环境中易松弛，备用是必要的',数量:2},
  { id:'匕首',icon:'🗡️',名称:'备用匕首',重量:0.12,分类:'武器',描述:'轻便的备用切割工具——固定刀柄，比猎刀小巧但同样锋利',耐久度:100,锋利度:98},
  { id:'投石器',icon:'🪨',名称:'投石器(简易)',重量:0.08,分类:'武器',描述:'简单的皮制投石器——抛射石子，安静无声。需要练习瞄准'},
  // 医疗 (11)
  { id:'急救包',icon:'🩹',名称:'急救包',重量:0.4,分类:'医疗',描述:'含消毒纱布、绷带卷、三角巾、医用胶带、一次性手套、小剪刀',耐久度:100},
  ...
  { id:'止泻药',icon:'💊',名称:'止泻药×6',重量:0.03,分类:'医疗',描述:'喝了不干净的水之后可能会有用——腹泻在荒野中是严重脱水风险',数量:6},
  { id:'抗过敏药',icon:'💊',名称:'抗过敏药×6',重量:0.03,分类:'医疗',描述:'不知名植物的接触过敏——在没有医院的地方这是唯一的防线',数量:6},
  { id:'眼药水',icon:'👁️',名称:'眼药水',重量:0.02,分类:'医疗',描述:'烟雾、灰尘、异物入眼——在篝火旁做饭时格外需要'},
  // 电子 (8)
  ...
  { id:'充电线',icon:'🔌',名称:'备用充电线',重量:0.05,分类:'电子',描述:'多接口充电线——手机、手电筒、营地灯通用。一根备用线多重保障'},
  { id:'营地灯',icon:'💡',名称:'LED营地灯(小型)',重量:0.2,分类:'电子',描述:'照亮整个营地——比手电筒更适合夜间劳作和烹饪。可调节亮度',耐久度:100},
  { id:'头灯',icon:'🔦',名称:'LED头灯',重量:0.08,分类:'电子',描述:'解放双手的照明——夜间搭建营地或处理伤口时的最佳选择',耐久度:100},
  // 特殊 (20)
  { id:'钓鱼套装',icon:'🎣',名称:'钓鱼套装',重量:0.1,分类:'特殊',描述:'鱼线+鱼钩+浮漂——在溪流中被动垂钓。抓到鱼就是一顿好饭'},
  ...
  { id:'蜡烛',icon:'🕯️',名称:'蜡烛×3',重量:0.15,分类:'特殊',描述:'照明+引火辅助——每支约可燃烧4-6小时。比手电筒更有篝火感',数量:3},
  { id:'防水火柴',icon:'🔥',名称:'防水火柴×20',重量:0.03,分类:'特殊',描述:'备用火源——即便浸水后甩干仍可使用。比打火机更可靠(极端天气下)',数量:20},
  { id:'缝纫工具包',icon:'🧵',名称:'缝纫工具包',重量:0.1,分类:'特殊',描述:'修补衣物和帐篷——针+线+顶针+备用纽扣。衣物在荒野中是消耗品'},
  { id:'炭笔素描本',icon:'✏️',名称:'炭笔×3+素描本',重量:0.15,分类:'特殊',描述:'记录+画画——在荒野中画看到的动物、植物...和想象中主人找到她的样子'},
  ...
  { id:'口琴',icon:'🎵',名称:'口琴',重量:0.1,分类:'特殊',描述:'精神慰藉——在漫长的独处夜晚吹一首主人喜欢的曲子。对野兽也有威慑作用(也许)'},
  { id:'防水袋',icon:'🎒',名称:'防水袋(大)',重量:0.15,分类:'特殊',描述:'卷口式防水袋——保护手机、地图、火柴等怕水的关键物品不被浸湿'},
  { id:'望远镜',icon:'🔭',名称:'小型望远镜',重量:0.25,分类:'特殊',描述:'远距离观察地形和野生动物——提前发现水源或危险。8倍放大'},
  { id:'驱虫喷雾',icon:'🧴',名称:'驱虫喷雾',重量:0.1,分类:'特殊',描述:'深秋昆虫虽少但仍有蚊虫——保护睡眠质量的关键'},
  { id:'速干毛巾',icon:'🧻',名称:'速干毛巾',重量:0.1,分类:'特殊',描述:'超细纤维速干——擦干身体和尾巴。湿尾在深秋荒野是致命的'},
  { id:'气象计',icon:'🌡️',名称:'简易气象计',重量:0.05,分类:'特殊',描述:'测量气压和温度趋势——预测天气变化。比手机更可靠'},
  { id:'登山扣',icon:'🔗',名称:'登山扣×3',重量:0.08,分类:'特殊',描述:'快速挂载装备到背包或腰带上——方便取用常用物品',数量:3},
  { id:'反光贴条',icon:'✨',名称:'反光贴条×10',重量:0.02,分类:'特殊',描述:'贴在背包和庇护所上——夜间用手电筒可以轻松找到营地',数量:10},
  { id:'防水笔记本',icon:'📔',名称:'防水笔记本(备用)',重量:0.08,分类:'特殊',描述:'无论下雨还是涉水都不会损坏——记录生存日志的最后备份'},
  { id:'鱼篓',icon:'🧺',名称:'折叠鱼篓',重量:0.2,分类:'特殊',描述:'可折叠的捕鱼篓——放置在溪流中被动捕鱼。比钓鱼更适合长时间等待'},
  { id:'浮漂套装',icon:'🎣',名称:'浮漂套装(多尺寸)',重量:0.05,分类:'特殊',描述:'不同水深的钓鱼浮漂——适应溪流、深潭、静水等不同水域'},
  // 材料 (9)
  ...
  { id:'铜线',icon:'🔗',名称:'铜线(一卷)',重量:0.15,分类:'材料',描述:'柔性金属线——制作陷阱机关、固定物品'},
  { id:'胶水',icon:'🪢',名称:'强力胶(小管)',重量:0.05,分类:'材料',描述:'快速修补——但干了之后只有一管。用在最关键的地方'},
  { id:'铁丝',icon:'🔗',名称:'铁丝(一卷)',重量:0.2,分类:'材料',描述:'比铜线更硬——制作大型陷阱框架或加固庇护所结构',耐久度:100},
  { id:'树皮绳',icon:'🪢',名称:'树皮绳(天然)',重量:0.1,分类:'材料',描述:'用树皮纤维手工搓制——强度一般但完全天然，可临时替代绳索'},
  { id:'松脂',icon:'🕯️',名称:'松脂(小块)',重量:0.05,分类:'材料',描述:'天然引火加速剂——湿木材沾上松脂也能点燃。也可用于防水处理'},
  { id:'燧石',icon:'🪨',名称:'燧石×3',重量:0.15,分类:'材料',description:'敲击产生火星——在没有打火机时的原始火源。每个可用数百次'},
  { id:'桦树皮',icon:'📜',名称:'桦树皮(引火材料)',重量:0.05,分类:'材料',描述:'极佳的天然引火物——薄如纸片，一点即燃。剥自白桦树'},
  // 烹饪与饮食 (6)
  { id:'折叠砧板',icon:'🪵',名称:'折叠砧板',重量:0.15,分类:'烹饪',描述:'处理猎物和食材——干净的切割表面。可折叠节省空间'},
  { id:'钛合金叉勺',icon:'🥄',名称:'钛合金叉勺',重量:0.03,分类:'烹饪',描述:'比塑料耐久、比钢铁轻——一把搞定汤和固体食物'},
  { id:'调料包',icon:'🌿',名称:'调料包(混合香料)',重量:0.08,分类:'烹饪',描述:'盐、胡椒、辣椒粉、蒜粉——让单调的猎物肉变成像样的饭菜'},
  { id:'茶蜡',icon:'🕯️',名称:'茶蜡×6',重量:0.1,分类:'烹饪',description:'小型的稳定火源——每支燃烧4小时。可用于小火加热或保持篝火余烬'},
  { id:'折叠烤架',icon:'🍖',名称:'折叠烤架(小型)',重量:0.3,分类:'烹饪',描述:'架在篝火上方的金属烤架——烤肉、烘鱼、晾干衣物'},
  { id:'打火棒',icon:'✨',名称:'打火棒(镁棒)',重量:0.05,分类:'烹饪',description:'没有燃料的火源——刮下镁屑用火星点燃。无限使用次数但有技巧门槛'},
];
